 ...
 */
exports.token = {
  expiresIn               : parseInt(process.env.ACCESS_TOKEN_TTL, 10) || 60 * 60,
 ...
 */
exports.codeToken = {
  expiresIn : parseInt(process.env.CODE_TOKEN_TTL, 10) || 5 * 60,
};
...
exports.refreshToken = {
  expiresIn : parseInt(process.env.REFRESH_TOKEN_TTL, 10) || 52560000,
};
